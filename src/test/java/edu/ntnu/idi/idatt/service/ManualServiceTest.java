 ...
 * verifying its behavior when loading manual text from resources.
 *
 * @version 0.1
 * @since 0.1
 * @author Trang Duong
...
public class ManualServiceTest {
  private final ManualService manualService = new ManualService();
  ...
  void testLoadManualTextSuccessfully() {
    ...
    assertFalse(result.isEmpty(), "Expected content in manual");
  }
