...
/**
 * Unit tests for {@link LaddersGameService},
 * verifying its behavior under various game configurations and actions.
 *
 * @version 0.1
 * @since 0.1
 * @author Trang Duong
...
public class LaddersGameServiceTest {
  ...
  /**
   * Verifies that attempting to play a turn before
   * the game has started throws a NullPointerException.
   */
  @Test
  ...
  /**
   * Verifies that constructing the service
   * with a null configuration throws a IllegalArgumentException.
   */
  @Test
  void testConstructorWithNullConfigThrows() {
    assertThrows(IllegalArgumentException.class,
          () -> new LaddersGameService(null, new DummyEventBus()));
  }

  /**
   * Verifies that constructing the service with a null event bus throws a IllegalArgumentException.
   */
  @Test
  void testConstructorWithNullEventBusThrows() {
    assertThrows(IllegalArgumentException.class, () -> new LaddersGameService(validConfig, null));
  }
