...
public class BoardGameTest {
  ...
  public void testSetUpGame() {
    ...
    for (Player player : players) {
      assertEquals(board.getStartTile(), player.getCurrentTile(),
            "Player should be placed on the start tile.");
    }
  }
  ...
  public void testGetEventBus() {
    assertEquals(eventBus, game.getEventBus(),
          "Event bus should be the same as the one used to create the game.");
  }
  ...
  public void testConstructorWithNullBoard() {
    assertThrows(IllegalArgumentException.class, () ->
          new BoardGame(null, players, dice, eventBus) {
      @Override
      protected void playTurn(Player player) {
      }
  ...
  public void testConstructorWithNullDice() {
    assertThrows(IllegalArgumentException.class, () ->
          new BoardGame(board, players, null, eventBus) {
      @Override
      protected void playTurn(Player player) {
      }
