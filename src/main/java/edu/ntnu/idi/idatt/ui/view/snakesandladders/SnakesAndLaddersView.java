 ...
 */
public class SnakesAndLaddersView implements View {
    /* --------------------------------------------------------------
     * FXML‑style fields & components
     * ----------------------------------------------------------- */
    private final BorderPane         root              = new BorderPane();
    private final SnakesAndLaddersBoardCanvas boardCanvas;
    ...
    public SnakesAndLaddersView() {
        boardCanvas = new SnakesAndLaddersBoardCanvas(500, 500);
