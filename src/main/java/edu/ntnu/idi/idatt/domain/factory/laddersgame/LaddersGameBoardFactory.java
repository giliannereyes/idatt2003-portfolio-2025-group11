...
import edu.ntnu.idi.idatt.domain.strategy.laddersgame.LaddersGameLayoutStrategy;
...
public class LaddersGameBoardFactory {
   ...
   */
  public LaddersGameBoardFactory(
    ...
    this.layoutStrategy = new LaddersGameLayoutStrategy();
