package edu.ntnu.idi.idatt.domain.game.laddersgame;
 ...
 */
public class LaddersGame extends BoardGame {
    /**
     * Constructs a SnakesAndLadders instance.
     */
    public LaddersGame(Board board, List<Player> players, Dice dice, EventBus eventBus) {
